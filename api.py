...
# request access to data using .get and sassign it to response
...
# create function to extract conversion rate from alphavantage
def api_function():
    # index exhange rate in data and convert to float before assigning to forex
